...
plugins {
    ...
    id("fabric-loom") version "1.16-SNAPSHOT" // Aligned with current Fabric toolchain
    id("maven-publish")
}
...
dependencies {
    ...
    // Keep Mod Menu API at compile time only; runtime jar should be provided separately.
